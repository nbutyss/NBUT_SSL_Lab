...
win32 {
    ...
    contains(QMAKE_TARGET.arch, x86_64){
        message("64-bit")
        CONFIG(release,debug|release){
            ZSS_LIBS += $${THIRD_PARTY_DIR}/protobuf/lib/libprotobuf.lib \
                        $${THIRD_PARTY_DIR}/tolua++/lib/tolua++.lib \
                        $${THIRD_PARTY_DIR}/lua/lib/lua5.1.lib
        }
        CONFIG(debug,debug|release){
            ZSS_LIBS += $${THIRD_PARTY_DIR}/protobuf/lib/libprotobufd.lib \
                        $${THIRD_PARTY_DIR}/tolua++/lib/tolua++D.lib \
                        $${THIRD_PARTY_DIR}/lua/lib/lua5.1.lib
        }
    } else {
        message("32-bit")
...
SOURCES += \
    ...
    src/Strategy/skill/canshoot.cpp \
