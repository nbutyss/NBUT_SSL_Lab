...
void CSmartGotoPositionV2::plan(const CVisionModule* pVision)
{
    ...
    if (avoidBallCircle){
        planCircleCenter = pVision->ball().Pos();
        planCircleRadius = 500;
    }
    ...
    cout<< "first:" << "avoidLength:" << avoidLength << "planCircleCenter:"<< planCircleCenter << "planCircleRadius:" << planCircleRadius << endl;
    ...
    cout<< "after:" << "avoidLength:" << avoidLength << "planCircleCenter:"<< planCircleCenter << "planCircleRadius:" << planCircleRadius << endl;
